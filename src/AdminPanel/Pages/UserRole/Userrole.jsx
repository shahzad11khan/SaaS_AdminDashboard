  ...
  return (
    ...
    <div className='flex flex-col lg:flex-row '>
        ...
        <div className='flex flex-col  lg:ml-10 w-full lg:w-[1000px] gap-3 '>
            <div className="para ">
                <p className='underline text-xl '>User Role</p>
            </div>
            ...
            <div className="table-container overflow-x-auto">
                ...
                <table className="border-collapse border border-gray-300 w-full ">
                    <thead>
                        <tr>
                            {userrole.headers.map((item, index) => (
                    ...
                    <tbody>
                        {userrole.data.map((item) => (
                            <tr key={item.id} className="hover:bg-gray-100">
                                <td className="text-center px-4 py-2">{item.sNo}</td>
                                <td className="text-center px-4 py-2">{item.userName}</td>
                                <td className="text-center px-4 py-2">{item.roleName}</td>
                                <td className="text-center px-4 py-2">{item.email}</td>
                                <td className="text-center px-4 py-2">{item.password}</td>

...
const Reports = () => {
  return (
    ...
    <div className='flex flex-col lg:flex-row '>
        ...
        <div className="para ">
                        <p className='underline text-xl '>Reports</p>
                    </div>
                    ...
                    <tbody>
                        {ReportData.data.map((item) => (
                            <tr key={item.sNo} className="hover:bg-gray-100">
                                ...
                                <td className="text-center px-4 py-2">{item.report_title}</td>
                                <td className="text-center px-4 py-2">{item.date_generated}</td>
                                <td className="text-center px-4 py-2">{item.generated_by}</td>

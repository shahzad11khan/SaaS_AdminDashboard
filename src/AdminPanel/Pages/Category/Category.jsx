    ...
    <div>
      ...
      <div className='flex flex-col lg:flex-row '>
        ...
        <div className='flex flex-col lg:ml-10 w-full lg:w-[1000px] gap-3 '>
          <div className="para">
            <p className={`underline text-xl ${currentTheme=== 'dark' ?'text-white':'text-black'}`}>Category Detail</p>
          </div>
          ...
          <div className="table-container overflow-x-auto">
            <table className="border-collapse border border-gray-300 w-full table-auto">
              <thead>
                <tr>
                  {categoryData.headers.map((item, index) => (
              ...
              <tbody>
                {categoryData.data.map((item) => (
                  <tr key={item.sNo} className={`hover:bg-gray-100 ${currentTheme === 'dark' ? 'hover:bg-[#404052]' : ''  }`}>
                    ...
                    <td className={`px-4 py-2 ${currentTheme=== 'dark' ?'text-white':'text-black'} text-center`}>{item.category_name}</td>

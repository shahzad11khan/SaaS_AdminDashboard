...
const Warehouse = () => {
  return (
    ...
    <div className='flex flex-col lg:flex-row '>
        ...
        <div className="para ">
                        <p className='underline text-xl '>Warehouse Detail</p>
                    </div>
                    ...
                    <tbody>
                        {warehouseData.data.map((item) => (
                            <tr key={item.sNo} className="hover:bg-gray-100">
                                ...
                                <td className="text-center px-4 py-2">{item.warehouse_id}</td>
                                <td className="text-center px-4 py-2">{item.location}</td>
                                <td className="text-center px-4 py-2">{item.capacity}</td>
                                <td className="text-center px-4 py-2">{item.manager_name}</td>
                                <td className="text-center px-4 py-2">{item.contact_number}</td>
